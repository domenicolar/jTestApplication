...
public class JTestApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JTestApplicationApp.class);

    private final Environment env;

    public JTestApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jTestApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JTestApplicationApp.class);
